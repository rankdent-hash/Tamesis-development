    ...
    <section className="py-24 lg:py-32 bg-navy-50">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
        <div className="max-w-2xl">
          <span className="text-xs font-mono uppercase tracking-widest text-teal-600 font-semibold">Insights</span>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {news.map((article) => (
            <a key={article.title} href="/news" className="group corner-marks rounded-2xl overflow-hidden bg-white shadow-card hover:shadow-card-hover transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 text-xs font-mono uppercase tracking-widest text-teal-600 font-semibold">

    ...
    <section className="py-24 lg:py-32 bg-navy-50">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
        <div className="max-w-2xl">
          <span className="text-xs font-mono uppercase tracking-widest text-teal-600 font-semibold">What We Do</span>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-5">
          {services.map((service) => (
            ...
            >
              <span className="flex w-11 h-11 items-center justify-center rounded-xl bg-teal-50 text-teal-600 group-hover:bg-teal-600 group-hover:text-white transition-colors">
              ...
              <span className="mt-5 flex items-start justify-between gap-2">
                ...
                <ArrowUpRight
                  size={16}
                  className="shrink-0 mt-0.5 text-slate-light group-hover:text-teal-600 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all"
                />
              </span>
            </a>
          ))}

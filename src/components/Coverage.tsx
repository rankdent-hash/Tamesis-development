  ...
  return (
    <section className="py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          <span className="text-xs font-mono uppercase tracking-widest text-teal-600 font-semibold">Coverage</span>
        ...
        <div className="corner-marks relative rounded-2xl overflow-hidden aspect-square bg-navy-900 blueprint-grid shadow-card-hover">
          <div className="absolute inset-0 bg-gradient-to-br from-navy-950/50 to-teal-700/30" />
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="w-4 h-4 rounded-full bg-teal-400 ring-8 ring-teal-400/20 animate-pulse" />
          </div>
          <span className="absolute bottom-4 left-4 text-[10px] font-mono uppercase tracking-widest text-navy-100/60 bg-navy-950/40 rounded px-2 py-1">

    ...
    <section className="py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
        <div className="max-w-2xl">
          <span className="text-xs font-mono uppercase tracking-widest text-teal-600 font-semibold">Who We Work With</span>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {sectors.map((sector) => (
            ...
            >
              <span className="flex w-12 h-12 items-center justify-center rounded-xl bg-navy-900 text-teal-400">

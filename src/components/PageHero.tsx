...
export function PageHero({
  ...
  return (
    <section className="relative pt-40 lg:pt-48 pb-16 lg:pb-20 overflow-hidden bg-navy-950">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-8">
        ...
        <h1 className="mt-4 font-display font-extrabold text-white text-3xl sm:text-4xl lg:text-5xl leading-[1.1] max-w-2xl text-balance">
          {title}
        </h1>
        {subtitle && (
          <p className="mt-5 text-navy-100/75 max-w-xl leading-relaxed">{subtitle}</p>
        )}
      </div>
    </section>
  );

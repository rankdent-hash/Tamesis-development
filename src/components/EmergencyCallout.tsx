      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-8 py-14 flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap gap-4 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white text-blue-700 px-7 py-4 text-sm font-bold shadow-card hover:bg-blue-50 transition-colors"
          >

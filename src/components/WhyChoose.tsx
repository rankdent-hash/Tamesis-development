    ...
    <section className="py-24 lg:py-32 bg-navy-950 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-8">
        <div className="max-w-2xl">
          <span className="text-xs font-mono uppercase tracking-widest text-teal-400 font-semibold">Why Tamesis</span>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
          {whyChoose.map((item) => (
            <div key={item.name} className="flex items-start gap-4">
              <span className="flex w-11 h-11 shrink-0 items-center justify-center rounded-xl bg-white/5 border border-white/10 text-teal-400">
